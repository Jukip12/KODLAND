...
/projects - ипсользуй для просмотра текущих(-его) проектов(-а)
/update_projects - используй для изменения состояния текущих событий.
/delete - используй для удаления проекта из базы данных
/skills - используй для добавления скилла к проекту
...
def text_handler(message):
    ...
    if project in projects:
        ...
        return
    bot.reply_to(message, "Причина тряски?")
    info(message)
